...
\begin{itemize}
    \item \textbf{Safe}: Gồm các sinh viên đạt kết quả \textit{Pass} hoặc \textit{Distinction} (nhóm sinh viên an toàn).
    \item \textbf{Not Safe}: Gồm các sinh viên rơi vào trạng thái \textit{Fail} hoặc \textit{Withdrawn} (nhóm sinh viên gặp rủi ro học tập).
\end{itemize}
